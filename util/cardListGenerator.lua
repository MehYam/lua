...
function cardXMLToJSON(xml)
	...
	local id = xml.properties["CardID"]
	...
	--------------------------
	local function addTrait(trait, value)
		if value then
	...
	print('\t\t{')
	addTrait("name", cardName)
	addTrait("cost", cost)
	addTrait("type", cardType)
	addTrait("class", cardClass)
	addTrait("atk", cardAtk)
	addTrait("health", cardHealth)
	addTrait("durability", durability)
	addTrait("battlecry", battlecry)
	addTrait("taunt", taunt)
	addTrait("stealth", stealth)
	addTrait("freeze", freeze)
	addTrait("charge", charge)
	addTrait("divineShield", divineShield)
	addTrait("windFury", windFury)
